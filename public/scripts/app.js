...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    key: 'handleDelete',
    value: function handleDelete(optionRemove) {
      this.setState({
        option: this.state.option.filter(function (option) {
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        null,
        React.createElement(Header, { title: data.title, subtitle: data.subtitle }),
        React.createElement(Action, { hasOption: this.state.option.length > 0, handlePick: this.handlePick }),
        React.createElement(Options, { Option: this.state.option, handleDeleteOption: this.handleDeleteOption, handleDelete: this.handleDelete }),
...
var Options = function Options(props) {
  return React.createElement(
    ...
    props.Option.map(function (option) {
      return React.createElement(Option, { key: option, optionText: option, handleDelete: props.handleDelete });
    })
  );
};
...
var AddOption = function (_React$Component2) {
  ...
  function AddOption(props) {
    ...
    _this2.handdleAddOption = _this2.handdleAddOption.bind(_this2);
    _this2.state = {
      error: undefined
    };
    return _this2;
  ...
  _createClass(AddOption, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          'form',
          { onSubmit: this.handdleAddOption },
